...
[![mockup image](/assests/GET.png)](https://drive.google.com/file/d/1_NYHqBNA9M50tXCmX78eaFswus6BSquv/view)



The following animation shows GET routes to return a single user and a single thought being tested in Insomnia:

[![mockup image](/assests/GET.png)](https://drive.google.com/file/d/1mZGA3QcFgqlhjS3F4HYmbN7eRrmRli1h/view)


The following animation shows the POST, PUT, and DELETE routes for users being tested in Insomnia:
[![mockup image](/assests/GET.png)](https://drive.google.com/file/d/10UW1aTJM3I-ciBskZCW8ELxZPgSxnIPe/view)

In addition to this, your walkthrough video should show the POST, PUT, and DELETE routes for thoughts being tested in Insomnia.

The following animation shows the POST and DELETE routes for a user’s friend list being tested in Insomnia:
[![mockup image](/assests/GET.png)](https://drive.google.com/file/d/167WrzBJdDGTi48s_Jl4DT9_oe7fAWqOg/view)
